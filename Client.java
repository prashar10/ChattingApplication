...
public class Client extends JFrame implements ActionListener{
	...
	//creasting a constructor of Server class for the box layout/frame
	...
	Client() {
		...
		JLabel l3= new JLabel("Ronaldo"); 	// to write something on frame
		...
		setLocation(1100,200); //setting xaxis and yaxis location respect to our screen
	...
	public void actionPerformed(ActionEvent me) {
		...
		dout.writeUTF(out);	// to display the message sent from here to the server side
		t1.setText("");
		}
		catch (Exception e) {
